...
```{r, message=FALSE, warning=FALSE, comment=NA}
p
ggsave("../figures/Figure 2.pdf", width=7, height=7, units='in')
ggsave("../figures/Figure 2.jpeg", width=7, height=7, units='in', dpi = 300)
```
...
```{r, message=FALSE, warning=FALSE, comment=NA}
p
ggsave("../figures/Figure 4.pdf", width=6.25, height=5, units='in')
ggsave("../figures/Figure 4.jpeg", width=6.25, height=5, units='in', dpi = 300)
```
...
dat_ancom = read_csv("../data/fdr_power_ancom.csv")
...
ggsave("../figures/Figure 5a.pdf", width=6.25, height=5, units='in')
ggsave("../figures/Figure 5a.jpeg", width=6.25, height=5, units='in', dpi = 300)
